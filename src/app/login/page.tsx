  ...
  return (
    <div className="flex min-h-screen">
      ...
      >
        ...
        {/* Animated circles */}
        <div className="absolute top-1/3 left-1/3 w-64 h-64 rounded-full bg-indigo-900 opacity-10 mix-blend-screen animate-blob"></div>
        <div className="absolute top-2/3 right-1/4 w-80 h-80 rounded-full bg-blue-900 opacity-10 mix-blend-screen animate-blob animation-delay-2000"></div>
        <div className="absolute bottom-1/4 right-1/3 w-72 h-72 rounded-full bg-purple-900 opacity-10 mix-blend-screen animate-blob animation-delay-4000"></div>
